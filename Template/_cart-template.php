             ...
             <div class="row">
                 <div class="col-sm-9">
                     ...
                     <div class="row border-top py-3 mt-3">
                         <div class="col-sm-2">
                             <img src="./assets/products/1.jpg" style="height: 120px;" alt="cart1" class="img-fluid">
                         </div>
                         <div class="col-sm-8">
                             <h5 class="font-baloo font-size-20">Beauty xl single</h5>
                             <small>by bumba</small>
                             <!-- product rating -->
                             <div class="d-flex">
                     ...
                     <div class="row border-top py-3 mt-3">
                         <div class="col-sm-2">
                             <img src="./assets/products/3.jpg" style="height: 120px;" alt="cart1" class="img-fluid">
                         </div>
                         <div class="col-sm-8">
                             <h5 class="font-baloo font-size-20">Premier md single</h5>
                             <small>by bumba</small>
                             <!-- product rating -->
                             <div class="d-flex">
                                 <div class="rating text-warning font-size-12">
